...
var a = numbers.includes(3);
console.log(a);
var b = fruits.includes('SOYEON');
console.log(b);

// 문제

var a동 = ["A502", "A504", "A203", "A305", "A530"];
var b동 = ["B202", "B609", "B303"];
var c동 = ["C403", "C408"];
...
var sumArr = c동.concat(a동, b동);
console.log('sumArr:', sumArr);
var thrid = sumArr.filter(function (sumArr) {
  return sumArr.indexOf('30') == 1;
});
//

var arr2 = sumArr.filter(function (str) {
  return str.includes == '30';
});
console.log("arr2 ::: ", arr2);
console.log('thrid:', thrid);
var five = thrid.filter(function (thrid) {
  return thrid.indexOf('305') == 1;
});
